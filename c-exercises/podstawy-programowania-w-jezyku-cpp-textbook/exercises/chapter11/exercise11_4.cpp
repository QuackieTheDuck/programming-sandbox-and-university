// przesuniecie ma byc zmienne zalezne od slowa kluczowwgo
// przesuniecie jest definiowane pozycja litery w alfabecie
...
void tworz_klucz (char* klucz_char, int dlug_klucz){
    ...
    //for (int i=0; i<dlug_klucz; ++i) cout<<int(klucz_char[i])<<endl;
}

void szyfrowanie(char* wyraz, char* klucz, int dlug_klucz, int dlug_wyraz){
    //cout<<endl<<dlug_wyraz<<endl;
...
int main(){
  ...
  male(wyraz); 
  //cout<<wyraz<<endl;
  //do przetestowania prztestowane dziala
  konwertuj(wyraz, wyraz_char, dlug_wyraz);
  //dlug_wyraz=wyraz.length();
  //wyraz_char=new char[dlug_wyraz];
  //wyraz_char=wyraz.data();
  //cout<<wyraz<<endl;
  //for(int i=0; i<dlug_wyraz; ++i) cout<<wyraz_char[i]<<endl;
  //cout<<dlug_wyraz<<endl;
  //cout<<dlug_wyraz<<endl;
  cout<<"Podaj klucz: "<<endl;
  cin>>klucz;
  male(klucz);
  //cout<<klucz<<endl;
  //cout<<"dlugosc klucza "<<klucz.length();
  konwertuj(klucz, klucz_char, dlug_klucz);
  //cout<<klucz<<endl;
  //for(int i=0; i<dlug_klucz; ++i) cout<<klucz_char[i]<<endl;
  //cout<<dlug_klucz<<endl;
  //dlug_klucz=klucz.length();
  //klucz_char= new char[dlug_klucz];
  //klucz_char=klucz.data();
  //for(int i=0; i<dlug_klucz; ++i) cout<<klucz_char[i]<<endl;
